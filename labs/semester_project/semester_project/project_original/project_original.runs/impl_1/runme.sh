...
HD_PWD='C:/Users/filip/OneDrive/Dokumenty/Github/Digital-electronics-1/labs/semester_project/semester_project/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm02.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm02.tcl -notrace
